...
from nanofactorysystem.aerobasic.programs.drawings import BinaryGrating, Apertures
...
def binary_testprint(absolute_center: Point2D, resin_dimension: list, ask_continue_box=False, path=None,
    ...
    if path is None:
        ...
        assert (path, Path)
        path = Path(mkdir(os.path.join(path, "grating_test"), clean=False))
    ...
    with Experiment(
        ...
        experiment.add_structure(
            ...
            name=f"binary_s{parameterset["slice size"]}_h_{parameterset["hatch size"]}_v_10k_p0_3_No_Degree",
            axes="ABZ",
        ...
        experiment.add_structure(
            structure_type=StructureType.NORMAL,
            name=f"binary_s{parameterset["slice size"]}_h_{parameterset["hatch size"]}_v_10k_p0_3_No_Degree_no_alternating",
            axes="ABZ",
            power=parameterset["power"],
            structure=BinaryGrating(
                center=Point3D(0, 0, -2),
        ...
        experiment.add_structure(
            structure_type=StructureType.NORMAL,
            name=f"binary_s{parameterset["slice size"]}_h_{parameterset["hatch size"]}_v_10k_p0_3_No_Degree_Aperture_circle",
            axes="ABZ",
            power=parameterset["power"],
            structure=BinaryGrating(
                center=Point3D(0, 0, -2),
                ...
                velocity=parameterset["velocity"],
                acceleration=experiment.accel_a_um,
                aperture=Apertures.circular(radius=structure_size/2),
                hatch_angle_deg=0.0,
                alternating_hatch=True,
                fov_size=(fov, fov),
                usable_fov_fraction=0.85,
        ...
        # experiment 45 degree rot
        experiment.add_structure(
            structure_type=StructureType.NORMAL,
            name=f"binary_s{parameterset["slice size"]}_h_{parameterset["hatch size"]}_v_10k_p0_3_45_Degree",
            axes="ABZ",
            power=parameterset["power"],
            structure=BinaryGrating(
                center=Point3D(0, 0, -2),
        ...
        experiment.add_structure(
            structure_type=StructureType.NORMAL,
            name=f"binary_s{parameterset["slice size"]}_h_{parameterset["hatch size"]}_v_10k_p0_3_45_Degree_h_45deg",
            axes="ABZ",
            power=parameterset["power"],
            structure=BinaryGrating(
                center=Point3D(0, 0, -2),
        ...
        experiment.add_structure(
            structure_type=StructureType.NORMAL,
            name=f"binary_s{parameterset["slice size"]}_h_{parameterset["hatch size"]}_v_10k_p0_3_45_Degree_h_45deg_no_alternating",
            axes="ABZ",
            power=parameterset["power"],
            structure=BinaryGrating(
                center=Point3D(0, 0, -2),
